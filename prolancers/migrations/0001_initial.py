...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Prolancer'
        db.create_table('prolancers_prolancer', (
            ...
            ('mail_empresa', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('imagen', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('contador', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ...
            ('creado', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('prolancers', ['Prolancer'])


    def backwards(self, orm):
        # Deleting model 'Prolancer'
        db.delete_table('prolancers_prolancer')
    ...
    models = {
        ...
        'prolancers.prolancer': {
            'Meta': {'object_name': 'Prolancer'},
            'categoria': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'contador': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'creado': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'descripcion': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'direccion': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagen': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'mail_empresa': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
